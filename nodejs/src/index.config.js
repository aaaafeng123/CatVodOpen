export default {
    ...
    m3u8cj: {
      ...
      search: true
        ...
        baidu: [{
      name: '魔都采集',
      url: 'https://caiji.moduapi.cc/api.php/provide/vod/?ac=list',
      ...
      baidu: [{
      name: '淘片采集',
      url: 'https://taopianapi.com/cjapi/mc10/vod/xml.html',
      categories: ['动作片','喜剧片','爱情片','科幻片','恐怖片','剧情片','战争片','国产剧','欧美剧','韩剧','日剧','港剧','台剧','泰剧','海外剧','纪录片','大陆综艺','日韩综艺','港台综艺','欧美综艺','国产动漫','日韩动漫','欧美动漫','动画片','港台动漫','海外动漫','悬疑片','邵氏电影','电影资讯','明星资讯','预告片'],
      search: true
    }], 
      baidu: [{
      name: '百度采集',
      url: 'https://api.apibdzy.com/api.php/provide/vod/from/dbm3u8/at/xml/?ac=list',
      categories: ['动作片','喜剧片','爱情片','科幻片','恐怖片','剧情片','战争片','国产剧','欧美剧','韩剧','日剧','港剧','台剧','泰剧','海外剧','纪录片','大陆综艺','日韩综艺','港台综艺','欧美综艺','国产动漫','日韩动漫','欧美动漫','动画片','港台动漫','海外动漫','悬疑片','邵氏电影','电影资讯','明星资讯','预告片'],
      search: true
    }],
      kuaikan: [{
